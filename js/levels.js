...
var screenLayouts = {
	...
	1: {
		...
		"supervisor": {
			...
			"flipped": true,
			"texture": "blaine",
			"conditional": "tutorialPhase === 0 || (tutorialPhase >= 6 && tutorialPhase <= 8)",
		},
		"superbubble": {
			"type": "over",
			"x": 160,
		...
		"paper": {
			...
			"height": 560,
			"texture": "paper",
			"target": "progressTutorial(); sounds['paper'].play();",
		...
		"tutorialbubble": {
			...
			"flipped": true,
			"texture": "textbubbleM",
			"conditional": "tutorialPhase >= 6 && tutorialPhase <= 8",
		},
		"tutorialwords": {
			"type": "text",
			"x": 195,
		...
		"tutorialwords1": {
			...
			"x": 195,
			"y": 40,
			"text": "Blaine: So you definitely would not want to move a jumpy pad thingy here because then the prisoner would escape, got it? Definitely don't do this, that's how people get fired.",
			"wordWrap": 480,
			"font": "24px Arial",
			"align": "center",
			"color": "#000",
		...
		"tutorialwords2": {
			...
			"x": 195,
			"y": 50,
			"text": "Blaine: How about you give it a go, just make sure to not move that jumping pad to where I said before.",
			"wordWrap": 480,
			"font": "24px Arial",
			"align": "center",
			"color": "#000",
